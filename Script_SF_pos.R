...
d = read.csv('R/fatty_acids_results_no_blank_normal_plus.csv')
dim(d)
d[1:10,1:7]
...
####### look on GC
gc = read.csv('R/need_sunf_samples - Лист1.csv',header = T,skip = 1,check.names = F,dec = ',',fileEncoding = 'utf8')
